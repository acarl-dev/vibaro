...
Route::prefix('v1')->group(function () {
    // Public Artist Page (light rate limit)
    Route::middleware('throttle:public-api')->group(function () {
        Route::get('/p/{handle}', [PublicArtistPageController::class, 'show']);
        Route::get('/p/{handle}/contact/{label}', [PublicArtistPageController::class, 'contactRedirect']);
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        // All routes below require an artist page (bound to request)
        Route::middleware('artist-page')->group(function () {
            // Artist Page management
