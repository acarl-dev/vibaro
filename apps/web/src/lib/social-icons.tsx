...
export function BandcampIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
export function WebsiteIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
export function CustomLinkIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
export function getSocialIcon(platform: SocialPlatform, className?: string) {
  switch (platform) {
    ...
    case "bandcamp":
      return <BandcampIcon className={className} />;
    case "website":
      return <WebsiteIcon className={className} />;
    case "custom":
      return <CustomLinkIcon className={className} />;
    default:
      return <CustomLinkIcon className={className} />;
  }
}
